...
<head>
    ...
    <style>
        .gradient-custom-2 {
            ...
            background: -webkit-linear-gradient(to right, #ee7724, #d8363a, #7e82ae, #b44593);

            /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
            background: linear-gradient(to right, #24ee6e, #59d836, #63dd36, #b44593);
        }

        @media (max-width: 769px) {
            .gradient-custom-2 {
                background: linear-gradient(to right, #cdb49c, #5f8417, #d23475, #123593);
            }
        }
    </style>
